function showWidget(eventId, widgetType, modal, affiliateCode) {
    var options = {
...
function buildWidgetContainer(eventId, widgetType, modal, affiliateCode) {
    if (modal === 'on') {
    ...
    showWidget(eventId, widgetType, modal, affiliateCode);
}
...
function downloadWidgetJs(urlParams) {
    ...
    scriptElement.addEventListener('load', buildWidgetContainer.bind(null, urlParams.eid, urlParams.widgetType, urlParams.modal, urlParams.affiliateCode))
